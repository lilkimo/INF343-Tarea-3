...
func main() {
	command("AddCity", "coruscant", "temploJedi", string(12))
	command("AddCity", "coruscant", "senado", string(23))
	command("UpdateName", "coruscant", "senado", "sewers")
	command("DeleteCity", "coruscant", "temploJedi", string(0))
